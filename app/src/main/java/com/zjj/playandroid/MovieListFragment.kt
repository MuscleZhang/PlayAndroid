...
import com.zjj.playandroid.placeholder.PlaceholderContent;
import com.zjj.playandroid.databinding.FragmentMovieListBinding
import com.zjj.playandroid.databinding.MovieListContentBinding
...
class MovieListFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val itemDetailFragmentContainer: View? = view.findViewById(R.id.movie_detail_nav_container)
            ...
            with(holder.itemView) {
                ...
                setOnClickListener { itemView ->
                    ...
                    if (itemDetailFragmentContainer != null) {
                        ...
                        itemView.findNavController().navigate(R.id.show_movie_detail, bundle)
                    }
                }
