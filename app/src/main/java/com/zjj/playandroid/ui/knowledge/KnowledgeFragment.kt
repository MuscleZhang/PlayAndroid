...
//            startActivity(intent)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d("zjj", "sub fragment onCreate")
    }

    override fun onAttach(context: Context) {
        super.onAttach(context)
        Log.d("zjj", "sub fragment onAttach")

    }

    override fun onActivityCreated(savedInstanceState: Bundle?) {
        super.onActivityCreated(savedInstanceState)
        Log.d("zjj", "sub fragment onActivityCreated")
    }

    override fun onStart() {
        super.onStart()
        Log.d("zjj", "sub fragment onStart")
    }

    override fun onResume() {
        super.onResume()
        Log.d("zjj", "sub fragment onResume")
    }

    override fun onPause() {
        super.onPause()
        Log.d("zjj", "sub fragment onPause")
    }

    override fun onStop() {
        super.onStop()
        Log.d("zjj", "sub fragment onStop")
    }

    override fun onDestroy() {
        super.onDestroy()
        Log.d("zjj", "sub fragment onDestroy")
    }

    override fun onDetach() {
        super.onDetach()
        Log.d("zjj", "sub fragment onDetach")
    }
